...
\begin{frame}{Gewählte Mitglieder}
  \begin{minipage}{.32\textwidth}
    ...
    \captionof*{figure}{Andreas Drottloff\\Uni Würzburg}
  \end{minipage}
  \begin{minipage}{.32\textwidth}
    \centering
    \includegraphics[height=0.25\textheight]{chris.jpeg}
    \captionof*{figure}{Christoph Blattgerste\\Uni Heidelberg}
  \end{minipage}
  \begin{minipage}{.32\textwidth}
    \centering
    \includegraphics[height=0.25\textheight]{chris.jpeg}
    \captionof*{figure}{Leon Nutzinger \\FU Berlin}
  \end{minipage}
  ...
  \begin{minipage}{.3\textwidth}
    \centering
    \includegraphics[height=0.25\textheight]{chris.jpeg}
    \captionof*{figure}{Anna Summers \\Uni Kiel}
  \end{minipage}
  \hspace{0.1\textwidth}
  \begin{minipage}{.3\textwidth}
    \centering
    \includegraphics[height=0.25\textheight]{chris.jpeg}
    \captionof*{figure}{Victoria Schemenz \\Alumna}
  \end{minipage}
  \hspace{0.1\textwidth}
