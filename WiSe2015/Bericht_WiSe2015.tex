...
\begin{frame}{Zukunft der StAPF-Arbeit}
	\begin{itemize}
		\item es lief nicht alles Rund
		\item über Gründe haben wir uns auf der Klausurtagung gedanken gemacht
		\item genaures dazu im AK \textbf{Der StAPF stellt sich vor}
	\end{itemize}
\end{frame}
